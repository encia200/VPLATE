...
public abstract class BaseVideoItem implements VideoItem, ListItem {
    ...
    public void setActive(View newActiveView, int newActiveViewPosition) {
        ...
        YoYo.with(Techniques.FadeIn).playOn(viewHolder.mRelativeLayout);
        viewHolder.mCover.setVisibility(View.INVISIBLE);
        //viewHolder.mRelativeLayout.setVisibility(VISIBLE);
    ...
    public View createView(ViewGroup parent, int screenWidth) {
        ...
        videoViewHolder.mPlayer.addMediaPlayerListener(new MediaPlayerWrapper.MainThreadMediaPlayerListener() {
            ...
            public void onVideoStoppedMainThread() {
                ...
                YoYo.with(Techniques.FadeOut).playOn(videoViewHolder.mRelativeLayout);

                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        //videoViewHolder.mRelativeLayout.setVisibility(View.INVISIBLE);
                        videoViewHolder.mCover.setVisibility(VISIBLE);
                    }
                }, 1000);
